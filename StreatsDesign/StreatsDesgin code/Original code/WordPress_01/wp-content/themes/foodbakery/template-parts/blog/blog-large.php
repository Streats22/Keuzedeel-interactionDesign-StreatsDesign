		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="swiper-wrapper">
						...
						if ('' != $gallery_image_id) {
						    ...
						    echo '<figure class="swiper-slide">
													<a href="javascript:void(0)"><img src="' . esc_url($foodbakery_var_src[0]) . '" alt=""></a></figure>';
						}
					    }
					    ?>
					</div>
			...
			<?php if ($foodbakery_blog_description == 'yes') { ?>
	    		<div class="text-holder">
				    ...
				    ?>
	    			<p><?php echo esc_html('Posted by', 'foodbakery'); ?><a href="<?php echo get_author_posts_url($authid); ?>"><?php echo esc_attr($author_name); ?></a> <?php echo esc_html__('on', 'foodbakery'); ?> <a class="date-archive-link" href="<?php echo get_month_link($archive_year, $archive_month); ?>"><?php echo esc_html($post_date); ?></a> <?php echo force_balance_tags($post_cats); ?> </p>
	    		    </div>
