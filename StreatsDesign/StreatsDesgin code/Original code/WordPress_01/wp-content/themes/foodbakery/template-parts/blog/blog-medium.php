	...
	if ($wpb_all_query->have_posts()) :
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="swiper-wrapper">
						...
						if ('' != $gallery_image_id) {
						    ...
						    echo '<figure class="swiper-slide">
							    <a href="javascript:void(0)"><img src="' . esc_url($foodbakery_var_src[0]) . '" alt=""></a>
							</figure>';
						}
					    }
					    ?>
			...
			<div class="text-holder">
				...
				<li> <?php echo force_balance_tags($post_cats); ?><span><a href="<?php echo esc_url(get_month_link(get_the_time('Y'), get_the_time('m'))); ?>"><?php echo get_the_date(' F j, Y'); ?> </a></span></li>
			    </ul>
