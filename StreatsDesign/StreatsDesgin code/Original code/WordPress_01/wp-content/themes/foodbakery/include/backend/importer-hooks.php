...
add_action( 'foodbakery_import_wp_data', 'foodbakery_import_wp_data_handle' );
if ( ! function_exists( 'foodbakery_import_wp_data_handle' ) ) {
	/**
	 ...
	 */
	function foodbakery_import_wp_data_handle( $obj ) {
		...
		if ( ! class_exists( 'WP_Import' ) ) {
			require_once $obj->foodbakery_importer_class_path;
		}
...
add_action( 'foodbakery_import_theme_options', 'foodbakery_import_wp_options_handle' );
if ( ! function_exists( 'foodbakery_import_wp_options_handle' ) ) {
	/**
	 * Import Theme Options
	 *
	 * @param CS_Data_Importer $obj An instance of CS_Data_Importer class which contains different configurations.
	 */
	function foodbakery_import_wp_options_handle( $obj ) {
		global $wp_filesystem;
		$theme_options = $wp_filesystem->get_contents( $obj->theme_options_data_path );
		$foodbakery_theme_skin = json_decode( $theme_options, true );
		update_option( 'foodbakery_var_options', $foodbakery_theme_skin );
...
add_action( 'foodbakery_import_menus_and_locations', 'foodbakery_import_menus_and_locations_handle' );
if ( ! function_exists( 'foodbakery_import_menus_and_locations_handle' ) ) {
	/**
	 * Set Menu's locations
	 *
	 * @param CS_Data_Importer $obj An instance of CS_Data_Importer class which contains different configurations.
	 */
	function foodbakery_import_menus_and_locations_handle( $obj ) {
...
add_action( 'foodbakery_import_setup_pages', 'foodbakery_import_setup_pages_handle' );
if ( ! function_exists( 'foodbakery_import_setup_pages_handle' ) ) {
	/**
	 * Set homepage for site
	 *
	 * @param CS_Data_Importer $obj An instance of CS_Data_Importer class which contains different configurations.
	 */
	function foodbakery_import_setup_pages_handle( $obj ) {
...
add_action( 'foodbakery_import_rev_sliders', 'foodbakery_import_rev_slider_handle' );
if ( ! function_exists( 'foodbakery_import_rev_slider_handle' ) ) {
	/**
	 * Import Revolution Slider content using Revolution slider's importer
	 *
	 * @param CS_Data_Importer $obj An instance of CS_Data_Importer class which contains different configurations.
	 */
	function foodbakery_import_rev_slider_handle( $obj ) {
		if ( class_exists( 'RevSlider' ) ) {
			global $wp_filesystem;
			$slider_data = $wp_filesystem->get_contents( $obj->sliders_data_path );
			$foodbakery_upload_dir = wp_upload_dir();
			$slider_file = $foodbakery_upload_dir['path'] . '/slider_data_' . time() . '.zip';
...
add_action( 'foodbakery_import_widgets', 'foodbakery_import_widgets_handle' );
if ( ! function_exists( 'foodbakery_import_widgets_handle' ) ) {
	/**
	 * Import Widgets
	 *
	 * @param CS_Data_Importer $obj An instance of CS_Data_Importer class which contains different configurations.
	 */
	function foodbakery_import_widgets_handle( $obj ) {
		if ( class_exists( 'foodbakery_var_widget_data' ) ) {
			foodbakery_var_widget_data::foodbakery_import_widget_data( $obj->widget_data_path );
			$obj->action_return = true;
		} else {
			$obj->action_return = false;
		}
