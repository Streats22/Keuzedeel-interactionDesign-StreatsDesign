...
if (!function_exists('foodbakery_var_promobox')) {
	...
	if ($foodbakery_var_promo_box_view == 'fancy') {
		...
		$foodbakery_var_promobox .= '<img src="' . esc_url($foodbakery_var_app_store_image_url_array) . '" alt="">';
		...
		$foodbakery_var_promobox .= '<img src="' . esc_url($foodbakery_var_google_store_image_url_array) . '" alt="">';
		$foodbakery_var_promobox .= '</a>';
	    }
