...
if ( ! function_exists( 'foodbakery_price_table_item' ) ) {
    ...
    function foodbakery_price_table_item( $atts, $content = null ) {
        ...
        if ( $foodbakery_price_table_style == 'classic' ) {
            ...
            $foodbakery_var_price_table_item .= '<div class="pricetable-holder center ' . esc_html( $active_class ) . '" ' . force_balance_tags( $foodbakery_price_table_column_bgcolor ) . '>';
            ...
            $foodbakery_var_price_table_item .= '
			<span style="color:' . force_balance_tags( $foodbakery_price_table_title_color ) . '!important;">';
            ...
            if ( $foodbakery_price_table_button_text <> '' ) {
                ...
                $foodbakery_var_price_table_item .= '<a style="background-color:' . force_balance_tags( $foodbakery_price_table_button_color_bg ) . '!important; color:' . force_balance_tags( $foodbakery_price_table_button_color ) . ' !important" href="' . esc_url( $foodbakery_button_link ) . '" class="text-color">' . esc_html( $foodbakery_price_table_button_text ) . ' <i class="icon-controller-play"></i></a>';
                $foodbakery_var_price_table_item    .= '</div>';
            }
            $foodbakery_var_price_table_item .= '</div>';
            $foodbakery_var_price_table_item .= '</div>';
        ...
        if ( $foodbakery_price_table_style == 'advance' ) {
            ...
            $foodbakery_var_price_table_item .= ' <div class="cs-price">';
            $foodbakery_var_price_table_item .= '<span ' . force_balance_tags( $foodbakery_price_table_column_bgcolor ) . '>';
            $foodbakery_var_price_table_item .= '<small>' . esc_html( $foodbakery_price_table_currency ) . '</small>';
            if ( $foodbakery_price_table_price <> '' ) {
                $foodbakery_var_price_table_item .= esc_html( $foodbakery_price_table_price );
            }
            $foodbakery_var_price_table_item .= '<strong style="color:' . force_balance_tags( $foodbakery_price_table_title_color ) . '!important;">' . esc_html( $foodbakery_price_table_text ) . '</strong>';
