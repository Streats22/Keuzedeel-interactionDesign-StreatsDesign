...
if ( ! function_exists( 'foodbakery_var_team_item_shortcode' ) ) {
    ...
    function foodbakery_var_team_item_shortcode( $atts, $content = "" ) {
        ...
        if ( $foodbakery_var_team_image <> '' ) {
            $html .= ' <figure><a href="' . $team_link . '"><img src="' . esc_url( $foodbakery_var_team_image ) . '" alt=""></a><figcaption><a href="' . $team_link . '"><span class="icon-add_box"></span></a></figcaption></figure>';
        }
        $html .= ' </div>';
