...
if ( ! class_exists( 'foodbakery_var_html_fields' ) ) {
    ...
    class foodbakery_var_html_fields extends foodbakery_var_form_fields {
        ...
        public function foodbakery_form_layout_render( $params = '' ) {
            ...
            $foodbakery_output .= '<img src="' . get_template_directory_uri() . '/assets/backend/images/no_sidebar.png"  alt="" />';
            ...
            $foodbakery_output .= '<span class="ss">';
            $foodbakery_output .= '<img src="' . get_template_directory_uri() . '/assets/backend/images/sidebar_right.png" alt="" />';
            $foodbakery_output .= '</span>';
            ...
            $foodbakery_output .= '<span class="ss">';
            $foodbakery_output .= '<img src="' . get_template_directory_uri() . '/assets/backend/images/sidebar_left.png" alt="" />';
            $foodbakery_output .= '</span>';
        ...
        public function foodbakery_var_heading_render( $params = '' ) {
            ...
            echo force_balance_tags( $foodbakery_var_output );
        }
	    ...
	    <label>' . esc_attr( $name ) . '</label>';
            ...
            $foodbakery_var_output .= '<div class="thumb-secs"> <img src="' . esc_url( $value ) . '" id="foodbakery_var_' . sanitize_html_class( $id ) . $foodbakery_var_random_id . '_img" width="100" alt="" />';
            ...
            if ( isset( $fields_list ) && is_array( $fields_list ) ) {
                foreach ( $fields_list as $field_array ) {
                    if ( $field_array['type'] == 'text' ) {
                        ...
                        $foodbakery_var_output .= '<ul id="gal-sortable">';
                        $foodbakery_var_output .= '<li class="ui-state-default" id="">';
                        $foodbakery_var_output .= '<div class="thumb-secs"> <img src="' . esc_url( $value ) . '" id="foodbakery_var_' . sanitize_html_class( $id ) . '_img" width="100" alt="" />';
