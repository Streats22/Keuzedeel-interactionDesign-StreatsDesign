                ...
                if (isset($foodbakery_layout) && ( $foodbakery_layout != '' || $foodbakery_layout != 'none' )) {
                    ...
                    if ($foodbakery_var_section_title != '' || $foodbakery_var_section_subtitle != '') {
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="cs-section-title" <?php echo force_balance_tags($title_align); ?>>
                                <?php if ($foodbakery_var_section_title != '') { ?>
                                    <h2 style="color:<?php echo force_balance_tags($foodbakery_section_titlt_color); ?> !important;"><?php echo esc_html($foodbakery_var_section_title);
                                    ?></h2>
                                <?php } if ($foodbakery_var_section_subtitle != '') { ?>
                                    <span style="color:<?php echo force_balance_tags($foodbakery_section_subtitlt_color); ?>;"><?php echo do_shortcode($foodbakery_var_section_subtitle) ?></span>
                                <?php } ?>
                            </div>
                        </div>
                        <?php
