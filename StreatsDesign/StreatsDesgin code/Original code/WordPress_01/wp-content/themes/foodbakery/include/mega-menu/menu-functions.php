...
if ( ! class_exists('cs_mega_custom_menu') ) {
	...
	class cs_mega_custom_menu {
		...
		function __construct() {
			...
			add_filter('wp_setup_nav_menu_item', array( $this, 'foodbakery_mega_add_custom_nav_fields' ));
			// save menu custom fields
			add_action('wp_update_nav_menu_item', array( $this, 'foodbakery_mega_update_custom_nav_fields' ), 10, 3);
			// edit menu walker
            add_filter('wp_edit_nav_menu_walker', array($this, 'foodbakery_mega_edit_walker'), 10, 2);
		}
		 ...
		 * @return      void
		 */
		function foodbakery_mega_add_custom_nav_fields($menu_item) {
		 ...
		 * @return      void
		 */
		function foodbakery_mega_update_custom_nav_fields($menu_id, $menu_item_db_id, $args) {
         ...
         * @return      void
         */
        function foodbakery_mega_edit_walker($walker, $menu_id) {
