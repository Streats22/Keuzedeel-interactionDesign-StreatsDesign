...
if ( ! function_exists( 'foodbakery_var_foodbakery_divider_shortcode' ) ) {
	...
	$html .= '<i class="icon-transport177"> </i> ';
	    ...
	    $html .= '<img src="' . get_template_directory_uri() . '/assets/frontend/images/divider.png"  alt="" /> ';
	}elseif($foodbakery_var_divider_style == 'modern_new'){
	    $html .= '<img src="' . get_template_directory_uri() . '/assets/frontend/images/divider-img.png"  alt="" /> ';
	}
	$html .= '</span> </div>';
        $html .= '</div>';
        $html .= '</div>';
