...
foodbakery_include_file(trailingslashit(get_template_directory()) . 'include/backend/cs-activation-plugins/cs-plugin-activation.php');
    ...
    function foodbakery_var_register_required_plugins() {
        ...
        $plugins = array(
            ...
            array(
                ...
                'slug' => 'revslider',
                'source' => trailingslashit(get_template_directory_uri()) . 'include/backend/cs-activation-plugins/revslider.zip',
                'required' => true,
                'version' => '6.1.3',
            ...
            array(
                ...
                'slug' => 'wp-foodbakery',
                'source' => trailingslashit(get_template_directory_uri()) . 'include/backend/cs-activation-plugins/wp-foodbakery.zip',
                'required' => true,
                'version' => '1.3',
                'force_activation' => false,
                'force_deactivation' => false,
            ...
            array(
                ...
                'source' => trailingslashit(get_template_directory_uri()) . 'include/backend/cs-activation-plugins/foodbakery-shortlists.zip',
                'required' => true,
                'version' => '1.3',
                'force_activation' => false,
                'force_deactivation' => false,
            ...
            array(
                ...
                'source' => trailingslashit(get_template_directory_uri()) . 'include/backend/cs-activation-plugins/foodbakery-email-templates.zip',
                'required' => true,
                'version' => '1.3',
                'force_activation' => false,
                'force_deactivation' => false,
