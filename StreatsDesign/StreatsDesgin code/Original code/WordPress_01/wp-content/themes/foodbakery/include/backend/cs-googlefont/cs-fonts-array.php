...
$var_arrays = array('foodbakery_var_fonts_subsets');
$fonts_array_global_vars = FOODBAKERY_VAR_GLOBALS()->globalizing($var_arrays);
extract($fonts_array_global_vars);
if (!function_exists('foodbakery_var_get_google_init_arrays')) {

    function foodbakery_var_get_google_init_arrays() {
        ...
        update_option('foodbakery_var_font_list', $font_list_init);
        update_option('foodbakery_var_font_attribute', $font_atts_int);
    }

}
$foodbakery_var_fonts_subsets = array(
