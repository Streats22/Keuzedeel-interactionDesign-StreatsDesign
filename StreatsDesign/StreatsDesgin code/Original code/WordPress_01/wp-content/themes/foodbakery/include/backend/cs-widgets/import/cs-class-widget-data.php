...
if (!class_exists('foodbakery_var_widget_data')) {
    ...
    class foodbakery_var_widget_data {
        ...
        public function __construct() {
            ...
            add_action('wp_ajax_foodbakery_widget_file_delete', array(__CLASS__, 'foodbakery_widget_file_delete'));
        }
        ...
        public static function export_settings_page() {
            ...
            <div class="widget-data cs-export-widget-settings">
                ...
                <div class="cs-export-wrapper">
                    ...
                    <div id="cs-widget-export-form">
                        <div class="title">
                            <h3><?php echo esc_html(foodbakery_var_theme_text_srt('foodbakery_var_widget_setting')); ?></h3>
                            <span class="cs-select-butns">
                                <a class="select-all"><?php echo esc_html(foodbakery_var_theme_text_srt('foodbakery_var_select_all')); ?></a>
                                <a class="unselect-all"><?php echo esc_html(foodbakery_var_theme_text_srt('foodbakery_var_unselect_all')); ?></a>
                            </span>
                            <div class="clear"></div>
                        </div>
                        <div class="sidebars">
            ...
            <?php
            $foodbakery_output = ob_get_clean();
            ...
            <?php if (isset($_POST['file_name']) && $_POST['file_name'] != '') : ?>
                    ...
                    <div class="cs-import-wrapper">
                        ...
                        <div id="cs-import-widget-form">
                            ...
                            <div class="title">
                                ...
                                <span class="cs-select-butns">
                                    <a class="imp-select-all"><?php echo esc_html(foodbakery_var_theme_text_srt('foodbakery_var_select_all')); ?></a>
                                    <a class="imp-unselect-all"><?php echo esc_html(foodbakery_var_theme_text_srt('foodbakery_var_unselect_all')); ?></a>
                                </span>
                                <div class="clear"></div>
                            </div>
                            <div class="sidebars">
                ...
                <?php endif; ?>
                            ...
                            <p>
                                ...
                                <label for="clear-current"><?php echo esc_html(foodbakery_var_theme_text_srt('foodbakery_var_clear_current')); ?></label><br/>
                                <span class="description"><?php echo esc_html(foodbakery_var_theme_text_srt('foodbakery_var_all_active')); ?></span>
                            </p>
                    ...
                    ?>
                    <p><?php echo esc_html(foodbakery_var_theme_text_srt('foodbakery_var_put_file')); ?></p>
                    <p>
                        <input type="text" id="cs-widget-upload-file" />
                    </p>
                    <input type="button" id="widget-import-submit" class="button" value=<?php echo esc_html(foodbakery_var_theme_text_srt('foodbakery_var_show_widget_settings')); ?> />
            <?php endif; ?>
        ...
        public static function export_widget_settings() {
            ...
            if (isset($_POST['action']) && $_POST['action'] == 'export_widget_settings') {
                $backup_url = wp_nonce_url('themes.php?page=foodbakery_options_page');
               ...
               $foodbakery_upload_dir = get_template_directory() . '/include/backend/cs-widgets/import/widgets-backup/';
               
                $foodbakery_filename = trailingslashit($foodbakery_upload_dir) . 'widget_' . (current_time('d-M-Y_H.i.s')) . '.json';

                $foodbakery_widgets_file = self::parse_export_data($_POST);

                if (!$wp_filesystem->put_contents($foodbakery_filename, $foodbakery_widgets_file, FS_CHMOD_FILE)) {
        ...
        public static function foodbakery_widget_file_delete() {

            global $wp_filesystem,$foodbakery_var_static_text;
            $strings = new foodbakery_theme_all_strings;
        $strings->foodbakery_theme_option_field_strings();
            $foodbakery_var_file_deleted_successfully = foodbakery_var_theme_text_srt('foodbakery_var_file_deleted_successfully');
            ...
            if (is_file($foodbakery_filename)) {
                ...
                printf($foodbakery_var_file_deleted_successfully, $file_name);
            } else {
        ...
        public static function ajax_import_widget_data() {
            ...
            if (empty($wp_filesystem)) {
                foodbakery_include_file(ABSPATH . '/wp-admin/includes/file.php');
                WP_Filesystem();
            }
         ...
         */
        public static function foodbakery_import_widget_data( $filename = "" ) {
			...
			if ( $filename == "" ) {
				$foodbakery_upload_dir = get_template_directory() . '/include/backend/cs-widgets/import/import-widgets/';

				$file_name = 'import-widgets.json';

				$import_file = trailingslashit($foodbakery_upload_dir) . $file_name;
			} else {
            ...
            if (is_array($sidebar_data)) {
                ...
                echo '<p><strong>' . foodbakery_var_theme_text_srt('foodbakery_var_widget_imported') . '</strong><br />';
            } else {
                echo '<p><strong>' . foodbakery_var_theme_text_srt('foodbakery_var_widget_not') . '</strong><br />';
            }
        }
...
$foodbakery_var_widget_data = new foodbakery_var_widget_data();
