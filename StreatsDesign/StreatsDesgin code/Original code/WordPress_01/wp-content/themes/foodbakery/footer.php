...
//echo $foodbakery_var_footer_style.'=======';
	    	...
	    	<div class="container">
	    		...
	    		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="footer-logo">
					    <a href="#"><img src="<?php echo $foodbakery_var_custom_footer_image; ?>" /></a>
					</div>
				    <?php } ?>
					...
					<div class="copy-right">
						...
						echo wp_kses(htmlspecialchars_decode($foodbakery_var_copy_right), $foodbakery_allowed_tags);
						?>
					    </p>
				...
				<?php } ?>
					...
					<div class="right-logos">
						...
						echo wp_kses(htmlspecialchars_decode($foodbakery_var_right_logos), $foodbakery_allowed_tags);
						?>
					    </p>
