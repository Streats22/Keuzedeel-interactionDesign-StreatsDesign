...
var Data = [
    {"Class": "column_100", "title": "100", "element": ["quote", "foodbakery_listings", "foodbakery_map_listings", "dealer", "mail_chimp", "price_table", "blog_search", "blog_categories", "tweets", "tabs", "maintenance", "foodbakery_register", "inventory_type", "package", "team", "contact_info", "flex_column", "promobox", "inventories", "compare_inventories", "clients", "woo_feature", "image_frame", "flex_editor", "stylist", "heading", "tabs_fancy", "video", "call_to_action", "price_services", "button", "maintenance", "listing_price", "counter", "ads", "gallery", "faq", "blog", "author", "map", "contact_form", "image_frame", "spacer", "accordion", "testimonial", "promobox", "list", "divider", "sitemap", "icon_box", "progressbars", "table", "schedule", "editor", "dropcap", "infobox", "faqs_fancy", "foodbakery_restaurants", "about_info"]},
    {"Class": "column_75", "title": "75", "element": ["quote", "foodbakery_listings", "foodbakery_map_listings", "dealer", "price_table", "mail_chimp", "blog_search", "blog_categories", "tweets", "tabs", "maintenance", "foodbakery_register", "inventory_type", "package", "team", "contact_info", "flex_column", "promobox", "inventories", "compare_inventories", "clients", "woo_feature", "flex_editor", "stylist", , "heading", "tabs_fancy", "video", "call_to_action", "price_services", "button", "maintenance", "listing_price", "counter", "ads", "gallery", "faq", "blog", "author", "map", "contact_form", "spacer", "accordion", "testimonial", "promobox", "list", "divider", "image_frame", "sitemap", "icon_box", "progressbars", "table", "schedule", "editor", "dropcap", "infobox", "faqs_fancy", "foodbakery_restaurants", "about_info"]},
    {"Class": "column_67", "title": "67", "element": ["quote", "foodbakery_listings", "foodbakery_map_listings", "dealer", "price_table", "mail_chimp", "blog_search", "blog_categories", "tweets", "tabs", "maintenance", "foodbakery_register", "inventory_type", "package", "team", "contact_info", "flex_column", "promobox", "inventories", "compare_inventories", "clients", "woo_feature", "image_frame", "flex_editor", "stylist", "heading", "tabs_fancy", "video", "call_to_action", "price_services", "button", "maintenance", "listing_price", "counter", "ads", "gallery", "faq", "blog", "author", "map", "contact_form", "spacer", "accordion", "testimonial", "promobox", "list", "divider", "sitemap", "icon_box", "progressbars", "table", "schedule", "editor", "dropcap", "infobox", "faqs_fancy", "foodbakery_restaurants"]},
    {"Class": "column_50", "title": "50", "element": ["quote", "foodbakery_listings", "foodbakery_map_listings", "dealer", "price_table", "mail_chimp", "blog_search", "blog_categories", "tweets", "tabs", "maintenance", "foodbakery_register", "inventory_type", "package", "team", "contact_info", "flex_column", "promobox", "inventories", "compare_inventories", "clients", "woo_feature", "image_frame", "flex_editor", "stylist", "heading", "tabs_fancy", "video", "call_to_action", "price_services", "button", "maintenance", "listing_price", "counter", "ads", "gallery", "faq", "blog", "author", "map", "contact_form", "spacer", "accordion", "testimonial", "promobox", "list", "divider", "sitemap", "icon_box", "progressbars", "table", "schedule", "editor", "dropcap", "infobox", "faqs_fancy", "foodbakery_restaurants", "about_info"]},
    {"Class": "column_33", "title": "33", "element": ["quote", "foodbakery_listings", "foodbakery_map_listings", "dealer", "price_table", "mail_chimp", "blog_search", "blog_categories", "tweets", "tabs", "maintenance", "foodbakery_register", "inventory_type", "package", "team", "contact_info", "flex_column", "promobox", "inventories", "compare_inventories", "clients", "woo_feature", "image_frame", "flex_editor", "stylist", "heading", "tabs_fancy", "video", "call_to_action", "price_services", "button", "maintenance", "listing_price", "counter", "ads", "gallery", "faq", "flex_editor", "blog", "author", "map", "contact_form", "spacer", "accordion", "testimonial", "promobox", "list", "divider", "sitemap", "icon_box", "progressbars", "table", "schedule", "editor", "dropcap", "infobox", "faqs_fancy", "foodbakery_restaurants"]},
    {"Class": "column_25", "title": "25", "element": ["quote", "foodbakery_listings", "foodbakery_map_listings", "dealer", "price_table", "mail_chimp", "blog_search", "blog_categories", "tweets", "tabs", "maintenance", "foodbakery_register", "inventory_type", "package", "team", "contact_info", "flex_column", "promobox", "inventories", "compare_inventories", "clients", "woo_feature", "image_frame", "flex_editor", "stylist", "heading", "tabs_fancy", "video", "call_to_action", "price_services", "button", "maintenance", "listing_price", "counter", "ads", "gallery", "faq", "blog", "author", "map", "contact_form", "spacer", "accordion", "testimonial", "promobox", "list", "divider", "sitemap", "icon_box", "progressbars", "table", "schedule", "editor", "dropcap", "infobox", "faqs_fancy", "foodbakery_restaurants", "about_info"]},
];
...
jQuery(document).on("click", "button.notice-dismiss", function () {
    ...
    var newCustomerForm = "admin=yes&action=foodbakery_admin_dismiss_notice";
    jQuery.ajax({
        type: "POST",
        url: admin_url,
...
function foodbakery_page_composer_filterable(id) {
    "use strict";
...
function foodbakery_frame_createpop(data, type) {
    "use strict";
...
function foodbakery_frame_removeoverlay(id, text) {
    "use strict";
...
function foodbakery_frame_loader() {
    "use strict";
...
function foodbakery_frame_callme() {
    "use strict";
...
function foodbakery_createpopshort(object) {
    var _structure = "<div id='cs-pbwp-outerlay'><div id='cs-widgets-list'></div></div>";
...
function ajax_shortcode_widget_element(object, admin_url, POSTID, name) {
    ...
    if (shortcodevalue) {
        ...
        var foodbakery_random_num = Math.floor((Math.random() * 98989) + 1);

        var newCustomerForm = "action=foodbakery_var_page_builder_" + name + '&counter=' + foodbakery_random_num + '&shortcode_element_id=' + encodeURIComponent(shortcodevalue) + '&POSTID=' + POSTID + dcpt_element_data;
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                var foodbakery_close_id = object.closest(".column-in").next().find(".cs-heading-area").parent('div').attr('id');
                var foodbakery_save_btn = object.closest(".column-in").next().find(".cs-foodbakery-admin-btn");
                foodbakery_save_btn.attr('onclick', 'javascript:foodbakery_frame_removeoverlay(\'' + foodbakery_close_id + '\', \'filterdrag\')');
...
function foodbakery_decrement(id) {
...
function foodbakery_increment(id) {
    "use strict";
    var i, c;
    var $ = jQuery;
    var parent, ColumnIndex, CurrentWidget, CurrentColumn, module;
...
function foodbakery_shortcode_insert_editor(element_name, id) {
    "use strict";
    var $id = jQuery("#" + id),
            _this = jQuery(this),
            attributes = '',
...
var foodbakery_shortocde_selection = (function (val, admin_url, id) {

    foodbakery_frame_loader();
    jQuery("#" + id).parents('#cs-widgets-list').removeClass('wide-width');
    if (val != "") {
        var shortcode_counter = 1
        var action = "foodbakery_var_page_builder_" + val;
        ...
        jQuery.ajax({
            ...
            data: newCustomerForm,
            success: function (data) {
                foodbakery_fontnamesearch();
                foodbakery_frame_removeoverlay(id, 'widgetitem');
                foodbakery_frame_createpop(data, "csmedia");
                jQuery('.bg_color').wpColorPicker();
                jQuery('div.cs-drag-slider').each(function () {
                    var _this = jQuery(this);
                    _this.slider({
...
function foodbakery_fontnamesearch() {
...
function show_sidebar(id, random_id) {
    "use strict";
    var $ = jQuery;
    jQuery('input[class="radio_foodbakery_sidebar"]').click(function () {
...
function foodbakery_header_element_toggle(id) {
    "use strict";

    if (id == "no-header") {
        jQuery("#foodbakery_var_custom_header").hide();
        jQuery("#foodbakery_var_rev_slider_header").hide();
        jQuery("#foodbakery_var_map_header").hide();
        jQuery("#foodbakery_var_no_header").show();
    } else if (id == "breadcrumb_header") {
        jQuery("#foodbakery_var_rev_slider_header").hide();
        jQuery("#foodbakery_var_map_header").hide();
        jQuery("#foodbakery_var_no_header").hide();
        jQuery("#foodbakery_var_custom_header").show();
    } else if (id == "custom_slider") {
        jQuery("#foodbakery_var_custom_header").hide();
        jQuery("#foodbakery_var_no_header").hide();
        jQuery("#foodbakery_var_map_header").hide();
        jQuery("#foodbakery_var_rev_slider_header").show();
    } else if (id == "map") {
        jQuery("#foodbakery_var_custom_header").hide();
        jQuery("#foodbakery_var_no_header").hide();
        jQuery("#foodbakery_var_rev_slider_header").hide();
        jQuery("#foodbakery_var_map_header").show();
    } else {
        jQuery("#foodbakery_var_custom_header").hide();
        jQuery("#foodbakery_var_rev_slider_header").hide();
        jQuery("#foodbakery_var_map_header").hide();
...
function show_sidebar_page(id) {
    ...
    if (id == 'left') {
        $("#foodbakery_var_right_layout").hide();
        $("#foodbakery_var_left_layout").show();
        $("#foodbakery_var_second_right_layout").hide();
        $("#foodbakery_var_second_left_layout").hide();
    } else if (id == 'right') {
        $("#foodbakery_var_right_layout").show();
        $("#foodbakery_var_left_layout").hide();
        $("#foodbakery_var_second_right_layout").hide();
        $("#foodbakery_var_second_left_layout").hide();
        ...
        $("#foodbakery_var_left_layout").show();
        $("#foodbakery_var_second_right_layout").hide();
        $("#foodbakery_var_second_left_layout").show();
    } else if (id == 'both_right') {
        $("#foodbakery_var_right_layout").show();
        $("#foodbakery_var_left_layout").hide();
        $("#foodbakery_var_second_right_layout").show();
        $("#foodbakery_var_second_left_layout").hide();
    } else {
        $("#foodbakery_var_right_layout").hide();
        $("#foodbakery_var_left_layout").hide();
...
function foodbakery_shortcode_element_ajax_call(val, id, admin_url) {

    if (val != "") {
        var shortcode_counter = 1
        var action = val;
        var newCustomerForm = "shortcode_element=" + val + '&action=foodbakery_shortcode_element_ajax_call';
        var options = '';
        if (val == 'tabs_fancy') {
            $('input[name^="foodbakery_var_tabs_title"]').each(function () {
                if ($(this).val() != '') {
        ...
        if (val == 'faqs_fancy') {
            $('input[name^="foodbakery_var_faqs_title"]').each(function () {
                if ($(this).val() != '') {
                    options += '<option>' + $(this).val() + '</option>';
                }
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                $('select[name^="foodbakery_var_tabs_fancy_active"]').append(options);
                $('select[name^="foodbakery_var_faqs_fancy_active"]').append(options);
                jQuery('.bg_color').wpColorPicker();
                //_commonshortcode(id);
...
function foodbakery_var_page_subheader_style(foodbakery_value) {

    if (foodbakery_value == 'with_bg') {
        $('#foodbakery_var_subheader_with_bg').show();
        $('#foodbakery_var_subheader_with_bc').hide();
    } else {
        $('#foodbakery_var_subheader_with_bg').hide();
        $('#foodbakery_var_subheader_with_bc').show();
    }
}
 ...
 *  Shortcode element ajax call function
 ...
 var shortcode_counter = 1
 var action = val;
 var newCustomerForm = "shortcode_element=" + val + '&action=foodbakery_var_page_builder_testimonial';
 jQuery.ajax({
 type: "POST",
 url: admin_url,
 data: newCustomerForm,
...
function foodbakery_frame_option_save(admin_url) {
    "use strict"
...
function foodbakery_var_gallery_sorting_list(id, random_id) {
...
function foodbakery_var_num_of_items(id, rand_id, numb) {
    var foodbakery_var_gal_count = 0;
    jQuery("#gallery_sortable_" + rand_id + " > li").each(function (index) {
        foodbakery_var_gal_count++;
        jQuery('input[name="foodbakery_var_' + id + '_num"]').val(foodbakery_var_gal_count);
    });

    if (numb == '1' && numb != '') {
        var foodbakery_var_data_temp = jQuery('#foodbakery_var_' + id + '_temp');
        //if (jQuery('input[name="foodbakery_' + id + '_num"]').val() == numb) {
        foodbakery_var_data_temp.html('<input type="hidden" name="foodbakery_var_' + id + '[]" value="">');
        //}
    }
}

function foodbakery_var_createpop(data, type) {
    "use strict";
    var _structure = "<div id='cs-pbwp-outerlay'><div id='cs-widgets-list'></div></div>",
            $elem = jQuery('#cs-widgets-list');
    jQuery('body').addClass("cs-overflow");
...
function foodbakery_var_remove_overlay(id, text) {
    "use strict";
    jQuery("#cs-widgets-list .loader").remove();
    var _elem1 = "<div id='cs-pbwp-outerlay'></div>",
            _elem2 = "<div id='cs-widgets-list'></div>",
...
function foodbakery_switching_editor(is_builder_active, thisObj) {
    ...
    if (is_builder_active == "true") {
        ...
        jQuery("#add_page_builder_item").html("<div class='loader'><i class='icon-spinner icon-spin'></i></div>");
        //formData.append('action', 'foodbakery_generate_elements_view');
        ...
        jQuery.ajax({
            url: foodbakery_globals.ajax_url,
            data: 'post_id=' + post_id + '&content=' + content + '&action=foodbakery_generate_elements_view',
            type: 'POST',
            success: function (response) {
