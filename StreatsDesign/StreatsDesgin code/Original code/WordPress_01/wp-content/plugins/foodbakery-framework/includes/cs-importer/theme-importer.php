                    ...
                    <div class="importer-steps-containers-wrapper importer-text row">
                        ...
                        <div class="step-2-container validate-purchase-key hidden">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <p><?php _e('Please enter your item purchase code of ChimpStudio', 'foodbakery'); ?></p>
                                <?php
                                ...
                                <?php if ( $verify_code ) : ?>
                                    <form role="form">
                                        <div class="control-group">
                                            <label for="item-purchase-code"><?php _e('Envato Provided Item Purchase Code', 'foodbakery'); ?></label>
                                            <input type="text" name="item-purchase-code" id="item-purchase-code" class="form-contorl">
                                            <label class="purchase-code-error" style="color: #ff0000; display: none;"><?php _e('Please provide a valid Item Purchase Code', 'foodbakery'); ?></label><br>
                                            ...
                                            <label for="envato-email-address"><?php _e('Envato Provided Email Address', 'foodbakery'); ?></label>
                                            <input type="text" name="envato-email-address" id="envato-email-address" class="form-contorl">
                                            <br><br>
                                        </div>
                                    </form>
                                <?php else : ?>
                                    <h3 style="color: #069c14;"><?php _e('It seems that, you have already verified purchase code. Proceed to next step', 'foodbakery'); ?></h3>
                                    <input type="button" value="<?php _e('Deregister Purchase Code', 'foodbakery'); ?>" class="importer-next-btn release-purchase-code"><br><br><br>
                                <?php endif; ?>
                            </div>
                        </div>
                    ...
                    function change_step_callback(elem) {
                        ...
                        if (current_step == 1) {
                            ...
                            if (is_purchase_code_verified || is_purchase_code_already_verified) {
                                ...
                                alert("<?php echo __('Please provide product purchase code.', 'foodbakery'); ?>");
                                change_step = false;
                            }
