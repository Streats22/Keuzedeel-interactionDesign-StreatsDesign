...
if ( ! class_exists( 'Envato_Backup' ) ) {
  ...
  class Envato_Backup {
    ...
    /**
     * Helper function to sanitize the root foodbakery path.
     *
     * @access    public
     * @since     1.4
     *
    ...
    /**
     * Helper function to sanitize the archive foodbakery path.
     *
     * @access    public
     * @since     1.4
     *
    ...
    public function files() {
      ...
      if ( defined( 'RecursiveFoodbakeryIterator::FOLLOW_SYMLINKS' ) ) {
      
        $filesystem = new RecursiveIteratorIterator( new RecursiveFoodbakeryIterator( $this->root(), RecursiveFoodbakeryIterator::FOLLOW_SYMLINKS ), RecursiveIteratorIterator::SELF_FIRST, RecursiveIteratorIterator::CATCH_GET_CHILD );
     ...
     *
     * Used if RecursiveFoodbakeryIterator::FOLLOW_SYMLINKS isn't available
     *
     * @access    private
     * @since     1.4
     *
    ...
    public function exclude_string( $context = 'zip' ) {
      ...
      foreach( $excludes as $key => &$rule ) {
        ...
        /* Wrap foodbakery fragments and files in wildcards for zip */
