...
if ( ! function_exists('foodbakery_column_pb') ) {
    ...
    function foodbakery_column_pb($die = 0, $shortcode = '', $section_data = '') {
        ...
        <div class="cs-page-composer composer-<?php echo absint($rand) ?>" id="composer-<?php echo absint($rand) ?>" style="display:none">
            <div class="page-elements">
                <div class="cs-heading-area">
                    ...
                    <span class='cs-btnclose' onclick='javascript:foodbakery_frame_removeoverlay("composer-<?php echo absint($rand) ?>", "append")'><i class="icon-times"></i></span> 
                </div>
                <script>
        ...
        if ( isset($shortcode) && $shortcode <> '' ) {
            ?>
            <a class="button" href="javascript:foodbakery_frame_createpop('composer-<?php echo esc_js($rand) ?>', 'filter')"><i class="icon-plus-circle"></i><?php echo esc_html($foodbakery_var_insert_sc); ?> </a>
            <?php
        } else {
            ?>

            <div id="<?php echo esc_attr($randomno); ?>_del" class="column columnmain parentdeletesection column_100" >
                <div class="column-in"> <a class="button" href="javascript:foodbakery_frame_createpop('composer-<?php echo esc_js($rand) ?>', 'filter')"><i class="icon-plus-circle"></i> <?php echo esc_html($foodbakery_var_add_element); ?></a>
                    <p> 
                        <a href="javascript:foodbakery_frame_createpop('<?php echo esc_js($column_class . $randomno); ?>','filterdrag')" class="options">
                            ...
                            <div class="dragarea" data-item-width="col_width_<?php echo esc_attr($parts[$i]) ?>">
                                ...
                                <div class="draginner" id="counter_<?php echo absint($rand) ?>">
                                    ...
                                    foreach ( $shortcodes_array as $foodbakery_node ) {
                                        ...
                                        ?>
                                        <div id="<?php echo esc_attr($name . $foodbakery_counter); ?>_del" class="column  parentdelete  column_<?php echo $coloumn_class; ?> <?php echo esc_attr($shortcode_view); ?>" item="<?php echo $sc_name; ?>" data="<?php echo foodbakery_element_size_data_array_index($sc_element_size) ?>" >
                                            ...
                                            <div class="cs-wrapp-class-<?php echo esc_attr($foodbakery_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $foodbakery_counter) ?>" style="display: none;">
                                                <div class="cs-heading-area">
                                                    ...
                                                    <a href="javascript:;" onclick="javascript:foodbakery_frame_removeoverlay('<?php echo esc_attr($name . $foodbakery_counter); ?>', '<?php echo esc_attr($filter_element); ?>')" class="cs-btnclose"><i class="icon-times"></i></a>
                                                </div>
                                                <?php
                                                $foodbakery_opt_array = array(
                                                    'std' => 'shortcode',
                ...
                <div id="<?php echo esc_attr($column_class . $randomno); ?>" style="display:none">
                    <div class="cs-heading-area">
                        ...
                        <a href="javascript:foodbakery_frame_removeoverlay('<?php echo esc_js($column_class . $randomno); ?>','filterdrag')" class="cs-btnclose"><i class="icon-times"></i></a> </div>
                                            ...
                                            <div class="meta-input pattern">
                                                <div class='radio-image-wrapper'>
                                                    ...
                                                    <label for="radio_1<?php echo esc_attr($randomno) ?>"> 
                                                        <span class="ss"> <img src="<?php echo foodbakery_var_frame()->plugin_url() . 'assets/images/no_sidebar.png'; ?>"  alt="" />  </span>
                                                        <span  <?php
                                                        if ( $foodbakery_layout == "none" ) {
                                                ...
                                                <div class='radio-image-wrapper'>
                                                    ...
                                                    <label for="radio_2<?php echo esc_attr($randomno) ?>"> 
                                                        <span class="ss"><img src="<?php echo foodbakery_var_frame()->plugin_url() . 'assets/images/sidebar_right.png'; ?>" alt="" /></span> 
                                                        <span <?php
                                                        if ( $foodbakery_layout == "right" ) {
                                                            echo "class='check-list'";
                                                        }
                                                ...
                                                <div class='radio-image-wrapper'>
                                                    ...
                                                    <label for="radio_3<?php echo esc_attr($randomno); ?>">
                                                        <span class="ss">
                                                            <img src="<?php echo foodbakery_var_frame()->plugin_url() . 'assets/images/sidebar_left.png'; ?>" alt="" /></span> <span <?php
                                                        if ( $foodbakery_layout == "left" ) {
                                                            echo "class='check-list'";
                                                        }
                                                        ?> id="check-list">
...
if ( ! function_exists('foodbakery_element_setting') ) {
    ...
    function foodbakery_element_setting($name, $foodbakery_counter, $element_size, $element_description = '', $page_element_icon = 'icon-star', $type = '') {
        ...
        <div class="column-in">
            ...
            $foodbakery_var_form_fields->foodbakery_var_form_hidden_render($foodbakery_opt_array);
            ?>
            <a href="javascript:;" onclick="javascript:foodbakery_createpopshort(jQuery(this))" class="options"><i class="icon-cog3"></i></a>
...
if ( ! function_exists('foodbakery_ajax_element_setting') ) {
    ...
    function foodbakery_ajax_element_setting($name, $foodbakery_counter, $element_size, $shortcode_element_id, $foodbakery_POSTID, $element_description = '', $page_element_icon = '', $type = '') {
        ...
        <div class="column-in">
            ...
            <a href="javascript:;" onclick="javascript:ajax_shortcode_widget_element(jQuery(this), '<?php echo esc_js(admin_url('admin-ajax.php')); ?>', '<?php echo esc_js($foodbakery_POSTID); ?>', '<?php echo esc_js($name); ?>')" class="options"><i class="icon-cog3"></i></a><a href="#" class="delete-it btndeleteit"><i class="icon-trash-o"></i></a> &nbsp; <a class="decrement" onclick="javascript:foodbakery_decrement(this)"><i class="icon-minus3"></i></a> &nbsp; <a class="increment" onclick="javascript:foodbakery_increment(this)"><i class="icon-plus3"></i></a> 
            <span> 
                <i class="<?php echo $shortcode_icon . ' ' . str_replace("foodbakery_var_page_builder_", "", $name); ?>-icon"></i> 
                <strong>
                    <?php
