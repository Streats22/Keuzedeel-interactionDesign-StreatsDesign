    ...
    function import() {
        ...
        if ($this->is_content) {
            ...
            if ($this->action_return) {
                ...
                //$this->update_db();
                ob_end_clean();
                $this->make_output(true, __('WP data successfully got imported.', 'cs-frame'));
            } else {
                $this->make_output(false, __('Sorry importer class missing.', 'cs-frame'));
            }
        }
        ...
        if ($this->is_navitems) {
            ...
            ob_end_clean();
            if ($this->action_return) {
                $this->make_output(true, __('WP Navigation Menu Items successfully got imported.', 'cs-frame'));
            } else {
                $this->make_output(false, __('Sorry navigation menu items class missing.', 'cs-frame'));
            }
        }
        ...
        if ($this->is_media_attachments) {
            ...
            ob_end_clean();
            if ($this->action_return) {
                $this->make_output(true, __('WP Media Attachments successfully got imported.', 'cs-frame'));
            } else {
                $this->make_output(false, __('Sorry media attachments class missing.', 'cs-frame'));
            }
        }
