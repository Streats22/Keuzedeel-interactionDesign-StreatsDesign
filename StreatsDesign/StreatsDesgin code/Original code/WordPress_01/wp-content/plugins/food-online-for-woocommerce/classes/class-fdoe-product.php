    ...
    case 'woocommerce_thumbnail':
	 ...
	 default:
...

        {
			...
			$do_add_url =	'<span><a href="" class="add_to_cart_button fdoe_simple_add_to_cart_button product_type_simple" data-product_id="'. $this->id  .'" data-product_sku="'.$product->get_sku().'"   data-quantity="1" rel="nofollow">  <i  class="'.self::get_icon() .' fa-2x fdoe-item-icon" ></i></a></span>'
