...
&#9658; **Adding Tracking Code to WooCommerce Orders**: The plugin Order Tracking for WooCommerce allows you to add tracking code to each product. The tracking code can be added manually in the WooCommerce/Orders page, or you can bulk-adding using CSV file. Customers can check their tracking code in the My Account page or using the tracking URL in emails.
...
- **Paypal Sandbox supported**: The plugin provides a sandbox option that allows you to test the feature with a Paypal Sandbox account before using it with you live account.
...
- **More tracking API**: Besides TrackingMore, the premium version also supports AfterShip, EasyPost and Global Cainiao

- **reCAPTCHA**: reCAPTCHA v2 and v3 are available for tracking form, this will help reduce requests from bots

- **Required order id/email**: This option require customers to enter correct email/order id to be able to track their orders

- **Map order status when importing tracking from CSV**

- **Upcoming features**: Support webhooks to automatically update new tracking data when tracking status changes
