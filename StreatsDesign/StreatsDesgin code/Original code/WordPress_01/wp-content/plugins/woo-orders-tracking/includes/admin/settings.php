                    ...
                    <select name="<?php esc_attr_e( self::set( 'settings' ) ) ?>[email_woo][email_woo_position]"
						...
						foreach ( $email_woo_positions as $email_woo_position_k => $email_woo_position_v ) {
						    if($email_woo_position_k==='after_order_table'){
							    ?>
                                <option value="<?php esc_attr_e( $email_woo_position_k ) ?>" selected><?php esc_html_e( $email_woo_position_v ) ?></option>
							    <?php
                            }else{
							    ?>
                                <option value="<?php esc_attr_e( $email_woo_position_k ) ?>" disabled="disabled"><?php esc_html_e( $email_woo_position_v ) ?></option>
							    <?php
                            }
						}
						?>
                    ...
                    <select name="<?php esc_attr_e( self::set( 'settings' ) ) ?>[service_carrier][service_carrier_type]"
						...
						foreach ( $this->service_carriers_list as $item_slug => $item_name ) {
						    if($item_slug==='trackingmore'){
							    ?>
                                <option value="<?php esc_attr_e( $item_slug ) ?>" selected><?php echo $item_name; ?></option>
							    <?php
                            }else{
							    ?>
                                <option value="<?php esc_attr_e( $item_slug ) ?>" disabled><?php printf(__("%s - PREMIUM FEATURE",'woo-orders-tracking'),$item_name); ?></option>
							    <?php
                            }
						}
						?>
