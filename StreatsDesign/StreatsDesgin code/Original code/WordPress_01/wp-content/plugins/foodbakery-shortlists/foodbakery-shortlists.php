...
if ( ! class_exists( 'Foodbakery_Shortlists' ) ) {
    ...
    class Foodbakery_Shortlists {
        ...
        public function __construct() {
            // Define constants
            define( 'FOODBAKERY_SHORTLISTS_PLUGIN_VERSION', '1.0' );
                    ...
                    <div class="suggest-list-holder">
                        ...
                        <div class="text-holder">
                            <div class="post-title">
                                <h5><a href="<?php echo esc_url( get_the_permalink() ); ?>"><?php echo get_the_title(); ?></a></h5>
                            </div>
            ...
            if ( $user_id != 0 && $post_id != '' ) {
                ...
                if ( true === Foodbakery_Member_Permissions::check_permissions( 'shortlists' ) ) {
                    if ( isset( $figcaption_div ) && $figcaption_div == true ) {
                        ...
                        ?>
                        <a href="javascript:void(0);" class="shortlist-btn <?php echo esc_html( $class ); ?>" onclick="foodbakery_publisher_shortlist(this, '<?php echo intval( $post_id ); ?>', '<?php echo intval( $user_id ); ?>', '<?php echo esc_html( $before_label ); ?>', '<?php echo esc_html( $after_label ); ?>', '<?php echo esc_html( $before_icon ); ?>', '<?php echo esc_html( $after_icon ); ?>');">
                ...
                <a href="javascript:void(0);" class="<?php echo esc_html( $class ); ?>" data-toggle="modal" data-target="#sign-in">
                    <?php echo $shortlist_icon; ?><?php echo esc_html( $shortlist_text ); ?>
                </a>
