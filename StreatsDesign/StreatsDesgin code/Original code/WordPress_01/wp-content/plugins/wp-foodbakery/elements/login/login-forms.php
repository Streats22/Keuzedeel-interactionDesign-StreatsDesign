                            ...
                            <ul>
                                ...
                                if (is_user_logged_in()) {
                                    ...
                                    if ($google_enabled == 'on') :
                                        echo apply_filters('social_login_login_google', '<li><a onclick="javascript:show_alert_msg(\'' . esc_html__("Please logout first then try to login again", "foodbakery") . '\')" href="javascript:void(0);" rel="nofollow" title="google" data-original-title="google+" class="gplus"><span class="social-mess-top gplus-social-login" style="display:none">' . esc_html__('Please set API key', 'foodbakery') . '</span><i class="icon-google4"></i>'.esc_html__('Sign In With Google', 'foodbakery') .'</a></li>');
                                    endif;
                                } else {
                                    ...
                                    if ($google_enabled == 'on') :
                                        echo apply_filters('social_login_login_google', '<li><a  href="javascript:void(0);" rel="nofollow" title="google-plus" data-original-title="google+" class="social_login_login_google gplus"><span class="social-mess-top gplus-social-login" style="display:none">' . esc_html__('Please set API key', 'foodbakery') . '</span><i class="icon-google4"></i>'.esc_html__('Sign In With Google', 'foodbakery') .'</a></li>');
                                    endif;
                                }
