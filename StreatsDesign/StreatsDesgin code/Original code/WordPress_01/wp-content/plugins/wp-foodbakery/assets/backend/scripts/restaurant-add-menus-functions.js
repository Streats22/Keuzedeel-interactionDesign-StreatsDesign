...
function foodbakery_add_menu_item_extra(restaurant_counter, menu_item_counter) {
    ...
    jQuery.ajax({
        ...
        url: foodbakery_globals.ajax_url,
        dataType: 'json',
        data: 'action=foodbakery_admin_restaurant_menu_items_extra_fields&restaurant_ad_counter=' + restaurant_counter + '&menu_item_counter=' + menu_item_counter + '&count_extra_li=' + count_extra_li,
        success: function (response) {
...
function add_more_extra_option(restaurant_counter, menu_item_counter, title, price, currency_sign, count_extra_li) {
    jQuery('#menu-item-extra-fields-' + menu_item_counter + count_extra_li).append('<li id="menu-item-extra-field-' + menu_item_counter + count_extra_li + '" class="menu-item-extra-field">\n\
                    ...
                    <div class="row">\n\
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">\n\
                                    <div class="menu-item-extra-options">\n\
											<label>&nbsp;</label>\n\
                                            <a href="javascript:void(0);" onClick="add_more_extra_option(\'' + restaurant_counter + '\',\'' + menu_item_counter + '\',\'' + title + '\',\'' + price + '\',\'' + currency_sign + '\',\'' + count_extra_li + '\');">+</a>\n\
                                            <a href="javascript:void(0);" onClick="remove_more_extra_option(\'' + restaurant_counter + '\',\'' + menu_item_counter + '\',\'' + count_extra_li + '\');">-</a>\n\
                                    </div>\n\
                            </div>\n\
                    </div>\n\
            </div>\n\
...
function remove_more_extra_option(restaurant_counter, menu_item_counter, count_extra_li) {
    jQuery('#menu-item-extra-field-' + menu_item_counter + count_extra_li).remove();
}
