...
if ( ! class_exists('Foodbakery_Restaurant_Menus') ) {
	...
	class Foodbakery_Restaurant_Menus {
				...
				foreach ( $menu_item_extra['heading'] as $key => $value ) {
					...
					if ( is_array($menu_item_extra_titles) && sizeof($menu_item_extra_titles) > 0 ) {
						foreach ( $menu_item_extra_titles as $key => $menu_item_extra_title ) {
							...
							$form_extra_html .= '<ul id="menu-item-extra-fields-' . $menu_item_counter . $count_extra_li . '" class="menu-item-extra-fields">
												<li id="menu-item-extra-field-' . $menu_item_counter . $count_extra_li . '" class="menu-item-extra-field">
													<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
														<div class="row">
															<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																<div class="field-holder">
																	<label>' . esc_html__('Title', 'foodbakery') . '</label>
																	<input class="menu-item-extra-title" name="menu_item_extra[' . $menu_item_counter . '][' . $count_extra_li . '][title][]" type="text" value="' . esc_attr($menu_item_extra_title) . '" placeholder="' . esc_html__('Title', 'foodbakery') . '">
																</div>
															</div>
															<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																<div class="field-holder">
																	<label>' . esc_html__('Price', 'foodbakery') . ' (' . $currency_sign . ')</label>
																	<input class="menu-item-extra-price" name="menu_item_extra[' . $menu_item_counter . '][' . $count_extra_li . '][price][]" type="text" value="' . esc_attr($menu_item_extra_price) . '" placeholder="' . esc_html__('Price', 'foodbakery') . '">
																</div>
															</div>
															<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																<div class="menu-item-extra-options">
																	<label>&nbsp;</label>
																	<a href="javascript:void(0);" onClick="add_more_extra_option(\'' . $restaurant_add_counter . '\',\'' . $menu_item_counter . '\',\'' . esc_html__('Title', 'foodbakery') . '\',\'' . esc_html__('Price', 'foodbakery') . '\',\'' . $currency_sign . '\',\'' . $count_extra_li . '\');">+</a>
																	<a href="javascript:void(0);" onClick="remove_more_extra_option(\'' . $restaurant_add_counter . '\',\'' . $menu_item_counter . '\',\'' . $count_extra_li . '\');">-</a>
																</div>
															</div>
														</div>
													</div>
		...
		public function foodbakery_restaurant_menu_items_extra_fields_callback() {
			...
			<ul id="menu-item-extra-fields-' . $menu_item_counter . $count_extra_li . '" class="menu-item-extra-fields">
				<li id="menu-item-extra-field-' . $menu_item_counter . $count_extra_li . '" class="menu-item-extra-field">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="row">
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
			...
			<li class="menu-item-' . $menu_item_counter . '">
				<div class="drag-list">
					...
					<div class="list-price">
						<span><b>' . $currency_sign . '</b><b>' . $menu_item_price . '</b></span>
					</div>
