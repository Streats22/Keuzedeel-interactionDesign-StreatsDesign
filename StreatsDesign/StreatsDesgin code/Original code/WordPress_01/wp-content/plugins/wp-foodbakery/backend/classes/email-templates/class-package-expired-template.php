<?php
/**
 * Membership Expired Email Template.
 *
 * @since 1.0
 * @package	Foodbakery
 */

if ( ! class_exists( 'Foodbakery_package_expired_email_template' ) ) {

	class Foodbakery_package_expired_email_template {
		...
		public function __construct() {
			...
			add_action( 'foodbakery_package_expired_email', array( $this, 'foodbakery_package_expired_email_callback' ), 10, 2 );
		}

		public function foodbakery_package_expired_email_callback( $user = '', $package_id = '' ) {
			...
			if ( isset( $template['email_notification'] ) && $template['email_notification'] == 1 ) {
				...
				Foodbakery_package_expired_email_template::$is_email_sent1 = $this->is_email_sent;
			}
		}
	...
	new Foodbakery_package_expired_email_template();
}
