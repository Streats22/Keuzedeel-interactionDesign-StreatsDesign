														...
														<div class="row">
															...
															<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																<div class="menu-item-extra-options">
																	<label>&nbsp;</label>
																	<a href="javascript:void(0);" onClick="add_more_extra_option(\'' . $restaurant_add_counter . '\',\'' . $menu_item_counter . '\',\'' . __('Title', 'foodbakery') . '\',\'' . __('Price', 'foodbakery') . '\',\'' . $currency_sign . '\',\'' . $count_extra_li . '\');">+</a>
