...
if (!class_exists('Foodbakery_Restaurant_Type_Meta')) {
	...
	public function __construct() {
	    ...
	    add_action('wp_ajax_restaurant_add_nutri_icon_item', array($this, 'foodbakery_restaurant_nutri_icon_item'));
	    add_action('wp_ajax_nopriv_restaurant_add_nutri_icon_item', array($this, 'foodbakery_restaurant_nutri_icon_item'));
