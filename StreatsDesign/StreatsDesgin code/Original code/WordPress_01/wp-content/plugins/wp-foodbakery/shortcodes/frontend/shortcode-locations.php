...
if ( ! class_exists( 'Foodbakery_Shortcode_Locations_front' ) ) {
    ...
    class Foodbakery_Shortcode_Locations_front {
	    ...
	    $count = count($all_types);
            ...
            echo '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="more-btn-holder"><a class="more-btn" href="'.esc_url($locations_button_url).'">See more locations</a></div></div>';
            echo '</div>';
	      echo '</div>';
            if (function_exists('foodbakery_var_page_builder_element_sizes')) {
             echo  '</div>';
