                            ...
                            <?php if (($user_roles != '' && in_array("foodbakery_publisher", $user_roles))) {
                                ...
                                <ul>
                                    ...
                                    if ($publisher_profile_type != 'restaurant') {
                                        ...
                                        <li class="user_dashboard_ajax" id="foodbakery_publisher_bookings" data-queryvar="dashboard=bookings"><a href="<?php echo ($this->foodbakery_dashboar_top_menu_url('dashboard=bookings')); ?>"><i class="icon-file-text2"></i><?php echo esc_html__("My Bookings", "foodbakery") ?></a></li>
