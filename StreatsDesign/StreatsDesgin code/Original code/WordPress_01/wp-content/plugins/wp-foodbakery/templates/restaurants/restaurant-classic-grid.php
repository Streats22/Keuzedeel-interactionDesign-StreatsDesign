...
$listing_col_class = 'col-lg-4 col-md-4 col-sm-6 col-xs-12';
...
if ($restaurant_loop_obj->have_posts()) {
    $flag = 1;
    ?>
    <div class="listing classic-grid">
        <ul class="row">
	    <?php
	    if ($restaurant_ads_switch == 'yes') {
		...
		<li class="<?php echo esc_html($listing_col_class); ?>">
		    <div class="123list-post <?php echo esc_html($featured_class); ?>">
			...
			<div class="text-holder">
				...
				if ($restaurant_pickup_delivery == 'delivery' || $restaurant_pickup_delivery == 'delivery_and_pickup') {
	    			...
	    			<div class="post-time">
	    				...
	    				<div class="time-tooltip-holder"> <b class="tooltip-label"><?php esc_html_e('Delivery time', 'foodbakery') ?></b> <b class="tooltip-info"><?php echo esc_html__('Your order will be delivered in ' . $restaurant_delivery_time . ' minutes.', 'foodbakery'); ?></b> </div>
	    			    </div>
	    			</div>
				    <?php
				}
				if ($restaurant_pickup_delivery == 'pickup' || $restaurant_pickup_delivery == 'delivery_and_pickup') {
	    			...
	    			<div class="post-time">
	    			    ...
	    			    <div class="time-tooltip">
	    				<div class="time-tooltip-holder"> <b class="tooltip-label"><?php esc_html_e('Pickup time', 'foodbakery') ?></b> <b class="tooltip-info"><?php echo esc_html__('You can pickup order in ' . $restaurant_pickup_time . ' minutes.', 'foodbakery'); ?></b> </div>
	    			    </div>
	    			</div>
				    <?php
				}
				...
				?>
	    		    <span class="location"><?php echo esc_html(implode(', ', $get_restaurant_location)); ?></span>
				<?php
			    }
				...
				<?php } else{ ?>
			    <div class="list-rating">
				<?php echo esc_html_e('Reviews Coming Soon', 'foodbakery'); ?>
			    </div>
			    <?php
			    }
			    if ($open_close_show_labels == 'yes') : ?>
			    <?php $status = foodbakery_open_close_status($restaurant_id); ?>
			    <span class="restaurant-status <?php echo strtolower($status); ?>"><?php echo esc_html__($status, 'foodbakery'); ?></span>
			    <?php endif; ?>
			</div>
		    </div>
		</li>
