 ...
 * @return
 */
if (!class_exists('FOODBAKERY_Plugin_Notification_Helper')) {

    class FOODBAKERY_Plugin_Notification_Helper {
        ...
        public function __construct() {
            // Do Something here..
            $this->message = esc_html__('No recored found', 'foodbakery');
        }
    ...
    $foodbakery_plugin_notify = new FOODBAKERY_Plugin_Notification_Helper();
    global $foodbakery_plugin_notify;
}