 ...
 * Description:       WooCommerce Delivery Date & Time is a WooCommerce plugin extension that gives the facility of selecting delivery date and time on order checkout page. Moreover, you don't need to worry about the styling because the plugin adjusts with your WordPress theme.
 * Version:           1.2.7
 * Author:            CodeRockz
 ...
 */
define( 'CODEROCKZ_WOO_DELIVERY_VERSION', '1.2.7' );
