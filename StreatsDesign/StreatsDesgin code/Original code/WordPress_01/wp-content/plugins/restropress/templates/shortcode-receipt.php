...
$time_text		= $service_type == 'pickup' ? __( 'Pickup Time', 'restropress' ) : __( 'Delivery Time', 'restropress' );
?>
<table id="rpress_purchase_receipt" class="rpress-table">
	...
	<tbody>
		...
		<tr>
			...
			<td class="rpress_receipt_payment_status <?php echo strtolower( $payment_status ); ?>"><?php echo $payment_status; ?></td>
		</tr>

		<tr>
			<td class="rpress_receipt_order_status"><strong><?php _e( 'Order Status', 'restropress' ); ?>:</strong></td>
			<td class="rpress_receipt_order_status <?php echo strtolower( $order_status ); ?>"><?php echo ucfirst( $order_status ); ?></td>
		</tr>

		<tr>
			<td class="rpress_receipt_delivery_type"><strong><?php _e( 'Service Type', 'restropress' ); ?>:</strong></td>
			<td class="rpress_receipt_delivery_type <?php echo strtolower( $service_type ); ?>"><?php echo ucfirst( $service_type ); ?></td>
		</tr>
		...
		<?php 
			...
			?>
			<tr>
				<td class="rpress_receipt_delivery_date">
					<strong>
						<?php 
							echo sprintf( __( '%s Date' ), ucfirst( $service_type ) );
						?>:
					</strong>
				</td>
				<td class="rpress_receipt_delivery_date">
					<?php echo $delivery_date; ?></td>
			</tr>
		<?php endif; ?>
					...
					<td>
						...
						<div class="rpress_purchase_receipt_product_name">
							...
							<?php if ( !empty( $special_instruction ) ) : ?>
								<span> <?php _e( 'Special Instruction', 'restropress'); ?> : </span>
