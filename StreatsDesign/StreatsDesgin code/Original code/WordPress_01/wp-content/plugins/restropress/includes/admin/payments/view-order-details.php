				...
				<div id="post-body" class="metabox-holder columns-2">
                  ...
                  $delivery_date = $payment->get_meta( '_rpress_delivery_date' );
							...
							<div id="rpress-delivery-details" class="postbox rpress-order-data">
								<h3 class="hndle">
									<span><?php _e( 'Service Details', 'restropress' ); ?></span>
								</h3>
								<div class="inside">
									<div class="rpress-admin-box">
										<div class="rpress-delivery-details rpress-admin-box-inside">
											<p>
												<span class="label"><?php _e( 'Service Type:', 'restropress' ); ?></span>&nbsp;
												<?php  echo ucfirst( $delivery_type ); ?>
												</p>
											</div>
											<div class="rpress-delivery-details rpress-admin-box-inside">
												<p>
													<span class="label"><?php _e( 'Service Time:', 'restropress' ); ?></span>&nbsp;
													<?php
                      ...
                      <div class="rpress-delivery-details rpress-admin-box-inside">
                        <p>
                          <span class="label"><?php _e( 'Service Date:', 'restropress' ); ?></span>&nbsp;
                          <?php
					...
					<div id="postbox-container-2" class="postbox-container">
						<div id="normal-sortables" class="meta-box-sortables ui-sortable">
							...
							<?php if ( is_array( $cart_items ) ) :
										...
										<div class="row">
											...
											<div class="rpress-addon-items">
												...
												if( !empty($fooditem->ID) ) :
													...
													$addons = get_formatted_categoriesList($terms);
                              ...
                              $addon_price = !empty( $addon_items['price'] ) ? rpress_currency_filter( rpress_format_amount( $addon_items['price'] ) ) : '';
                              ...
                              if ( !empty( $selected_addon_items ) ) :
                              	...
                              	foreach( $selected_addon_items as $k => $selected_addon_item ) :
                              		...
                              		if ( in_array( $selected_addon_id, $addon_array ) ) {
                              			?>
                              			<option selected data-price="<?php echo $addon_price; ?>" data-id="<?php echo $addon_item_id; ?>" value="<?php echo $addon_item_name . '|' . $addon_item_id . '|' . $addon_price .'|'. '1' ; ?>"><?php echo $addon_item_name . ' (' . $addon_price . ') '; ?>    
                                </option>
                              			<?php
                              		}
                              	endforeach;
