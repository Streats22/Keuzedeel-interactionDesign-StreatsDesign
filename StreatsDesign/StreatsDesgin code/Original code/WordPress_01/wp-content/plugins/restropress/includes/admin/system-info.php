...
<?php do_action( 'rpress_system_info_before' ); ?>
...
Test Mode Enabled:        <?php echo rpress_is_test_mode() ? "Yes\n" : "No\n"; ?>
Ajax Enabled:             <?php echo rpress_is_ajax_enabled() ? "Yes\n" : "No\n"; ?>
Guest Checkout Enabled:   <?php echo rpress_no_guest_checkout() ? "No\n" : "Yes\n"; ?>

Checkout is:              <?php echo ! empty( $rpress_options['purchase_page'] ) ? "Valid\n" : "Invalid\n"; ?>
Checkout Page:            <?php echo ! empty( $rpress_options['purchase_page'] ) ? get_permalink( $rpress_options['purchase_page'] ) . "\n" : "\n" ?>
Success Page:             <?php echo ! empty( $rpress_options['success_page'] ) ? get_permalink( $rpress_options['success_page'] ) . "\n" : "\n" ?>
Failure Page:             <?php echo ! empty( $rpress_options['failure_page'] ) ? get_permalink( $rpress_options['failure_page'] ) . "\n" : "\n" ?>
RestroPress slug:           <?php echo defined( 'RPRESS_SLUG' ) ? '/' . RPRESS_SLUG . "\n" : "/fooditems\n"; ?>

Taxes Enabled:            <?php echo rpress_use_taxes() ? "Yes\n" : "No\n"; ?>
Taxes After Discounts:    <?php echo rpress_taxes_after_discounts() ? "Yes\n" : "No\n"; ?>
Tax Rate:                 <?php echo rpress_get_tax_rate() * 100; ?>%
...
WordPress Memory Limit:   <?php echo ( rpress_let_to_num( WP_MEMORY_LIMIT )/( 1024 ) )."MB"; ?><?php echo "\n"; ?>
...
<?php
// Show templates that have been copied to the theme's rpress_templates dir
...
do_action( 'rpress_system_info_after' );
?>
 ...
 * @return void
 */
function rpress_generate_sysinfo_fooditem() {
	nocache_headers();
...
add_action( 'rpress_fooditem_sysinfo', 'rpress_generate_sysinfo_fooditem' );
